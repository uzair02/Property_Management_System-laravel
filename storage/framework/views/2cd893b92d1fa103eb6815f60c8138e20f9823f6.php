...
<body>
    ...
    <h2 class="py-3" style="background-color:#E2E2E2; text-align:center; Font-size: 1.6rem; padding-bottom">
       <strong>Display All Property</strong> 
    </h2>
    <div class="container my-5">
        <table class="px-5 table table-striped py-5" id="property_table">
        <thead>
        <tr>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($property->pro_num); ?></td>
                <td><?php echo e($property->city); ?></td>
                <td><?php echo e($property->address); ?></td>
                <td><?php echo e($property->price); ?></td>
                <td><a class="btn" href="<?php echo e(URL::to('property/edit', $property->id+4436)); ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                    <a class="btn" href="<?php echo e(URL::to('property/delete', $property->id)); ?>" onclick="return confirm ('Are you sure to delete this Property <?php echo e($property->pro_num); ?> having Payment number <?php echo e($property->id); ?>?')"><i class="fa-regular fa-trash-can"></i></a></td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\PMS\resources\views/property/read.blade.php ENDPATH**/ ?>