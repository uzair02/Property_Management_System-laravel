...
<body>
    ...
    <div class="container my-5">
        ...
        <form class="px-3 py-3 row g-3" action="<?php echo e(route ('lease.update', $leases->id)); ?>" method="post">
            <legend style="text-align: center;"><strong>Update Lease</strong></legend>
            <hr style="border-top: dashed 1px; margin-bottom: 1rem;">
            <?php echo csrf_field(); ?>
            <div class="col-12">
                <label for="id" class="form-label">ID</label>
                <input type="text" class="form-control" id="id" name="id"  Value ="<?php echo e($leases->id); ?>" readonly>
            </div>
            <div class="col-12">
                <label for="lease_num" class="form-label">Lease Number</label>
                <input type="text" class="form-control" id="lease_num" name="lease_num" value="<?php echo e($leases->lease_num); ?>">
            </div>
            <div class="col-12">
                <label for="start_date" class="form-label">Start Date</label>
                <input type="text" class="form-control" id="start_date" name="start_date" value="<?php echo e($leases->start_date); ?>">
            </div>

            <div class="col-12">
                <label for="inputAddress" class="form-label">End Date</label>
                <input type="text" class="form-control" id="end_date" name="end_date" value="<?php echo e($leases->end_date); ?>">
            </div>
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Total Amount</label>
                <input type="text" class="form-control" id="amount" name="amount" value="<?php echo e($leases->total_price); ?>">
            </div>
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Security</label>
                <input type="text" class="form-control" id="security" name="security" value="<?php echo e($leases->security); ?>">
            </div>
            <div class="col-12">
...
<?php /**PATH C:\xampp\htdocs\PMS\resources\views/lease/update.blade.php ENDPATH**/ ?>