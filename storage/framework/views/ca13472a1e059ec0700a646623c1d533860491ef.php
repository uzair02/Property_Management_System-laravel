...
<body>
    ...
    <div class="container my-5">
        ...
        <form class="px-3 py-3 row g-3" action="<?php echo e(route ('monthlypayment.store')); ?>" method="post">
            <legend style="text-align: center;"><strong>Add New Monthly Payment Of Lease</strong></legend>
            <hr style="border-top: dashed 1px; margin-bottom: 1rem;">
            <?php echo csrf_field(); ?>
            <div class="col-12">
                <label for="paynum" class="form-label">Payment Number</label>
                <input type="text" class="form-control" id="paynum" name="paynum" placeholder ="Enter payment number">
            </div>
            <div class="col-12">
...
<?php /**PATH C:\xampp\htdocs\PMS\resources\views/monthlypayment/create.blade.php ENDPATH**/ ?>