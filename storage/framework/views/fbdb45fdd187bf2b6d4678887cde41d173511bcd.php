...
<body>
    ...
    <div class="container my-5">
        ...
        <form class="px-3 py-3 row g-3" action="<?php echo e(route ('user.verify')); ?>" method="post">
        <legend><strong>Sign in</strong></legend>
        <hr style="border-top: dashed 1px; margin-bottom: 1rem; text-align: center;">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Email address</label>
                <input type="email" class="form-control" id="email" name='email' aria-describedby="emailHelp" placeholder='abc@xyz.com'>
            </div>
            <div class="mb-3">
            ...
            <p class="mt-3">Don't have an account? <a href="<?php echo e(url('user/register')); ?>">Sign up</a></p> <!-- Added line for signing up -->
        </form>
    </div>
...
<?php /**PATH C:\xampp\htdocs\PMS\resources\views/user/login.blade.php ENDPATH**/ ?>