    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="<?php echo e(url('mail/contact')); ?>">Contact</a></li>
          <li class="dropdown"><a href="#"><span>Admin</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="<?php echo e(url('layouts/dash')); ?>">Dashboard</a></li>
            </ul>
          </li>
        </ul>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="<?php echo e(asset('assets/img/graana-1.jpg')); ?>" class="img-fluid" alt="">
                <a href="<?php echo e(asset('assets/img/graana-1.jpg')); ?>" data-gallery="portfolioGallery" class="link-preview portfolio-lightbox" title="Preview"><i class="bx bx-plus"></i></a>
...
</html><?php /**PATH C:\xampp\htdocs\PMS\resources\views//home_tem.blade.php ENDPATH**/ ?>