...
<body>
    ...
    <div class="container my-5">
        ...
        <form class="px-3 py-3 row g-3" action="<?php echo e(route ('property.storeSearchud')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="col-12">
    ...
    <form class="px-3 py-3 row g-3" action="<?php echo e(route ('property.sDelete')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="col-12">
            <label for="pro_num" class="form-label">Property Number</label>
            <input type="text" class="form-control" id="pro_num" name="pro_num" placeholder ="A-123">
...
<?php /**PATH C:\xampp\htdocs\PMS\resources\views/property/searchud.blade.php ENDPATH**/ ?>